            ...
            <div class="offer-info">
                ...
                <div class="offer-details">
                    ...
                    <div>
                        ...
                        <?= htmlspecialchars($detail["disponibilite"]) ?>
                    </div>
                    <div>
                        <strong>Date de création</strong>
                        <?= date("d/m/Y", strtotime($detail["date_creation"])) ?>
                    </div>
                </div>
                ...
                <?php if (isset($_SESSION['user_id']) && $_SESSION['user_id'] != $detail['user_id']): ?>
                    ...
                    <form class="contact-form" action="/send_message/" method="POST">
                        ...
                        <textarea class="form-textarea" name="message" required placeholder="Écrivez votre message ici..." rows="5"></textarea>
